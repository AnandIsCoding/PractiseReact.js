    ...
    return (
        <div className='w-full  flex justify-center items-center font-bold text-white'>
            <div className='w-[50%] h-full flex flex-col justify-center items-center'>
                <div className=' mb-[4vw] mt-10'>
                    <h1 className='text-center text-6xl font-bold mb-2'>Welcome Coders</h1>
                    <h2 className='text-center text-xs animate-pulse'>Build skills for today, tomorrow and beyond.</h2>
                    <h2 className='text-center text-xs animate-pulse'>Education to future-proof your career</h2>
                </div>
            ...
            <div className='w-[50%] h-full flex justify-center items-center'>
                <img 
                    src="src\assets\contactmewebp.jpg"
                    alt="Contact" 
                    className='w-full h-full object-cover mb-[-8vw] animate-bounce '
					loading='lazy' 
                />
            </div>
        </div>
